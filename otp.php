...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>OTP Verification | Multi Factor Voting System</title>
                                    ...
                                    <form class="form-horizontal auth-form my-4" action="helpers/verify.php" method="post" autocomplete="off">
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12 mt-2">
                                                <button class="btn btn-gradient-primary btn-round btn-block waves-effect waves-light" name="submit" type="submit">Verify Code <i class="fas fa-sign-in-alt ml-1"></i></button>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->
